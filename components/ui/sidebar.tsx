...
import { PanelLeftIcon, PanelRightOpen, PanelRightClose } from "lucide-react"
...
const SIDEBAR_KEYBOARD_SHORTCUT = "b" // "b" for sidebar
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      {state === "expanded" ? (
        <PanelRightOpen aria-hidden="true" className="size-5" strokeWidth={1.5} />
      ) : (
        <PanelRightClose aria-hidden="true" className="size-5" strokeWidth={1.5} />
      )}
