  ...
  if (!mounted) {
    return (
      <Button
        ...
        className="w-9 h-9 border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 text-slate-700 dark:text-slate-200 transition-colors cursor-pointer opacity-60"
      >
