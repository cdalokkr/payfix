        ...
        <>
            <SidebarMenu>
                <SidebarMenuItem>
                    ...
                    >
                        <div className="h-8 w-8 rounded-full shrink-0 transition-all group-hover/footer-item:ring-2 group-hover/footer-item:ring-primary group-hover/footer-item:ring-offset-1 group-hover/footer-item:ring-offset-sidebar">
                            <UserAvatar src={user?.avatar_url} alt={displayName} initials={getInitials()} className="h-8 w-8" />
                        </div>
