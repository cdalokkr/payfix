        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <MetricCard
                    ...
                    cardBgColor="bg-[#FFFFFF] dark:bg-zinc-900"
                    borderColor="border-x-gray-200/80 border-b-gray-200/80 dark:border-x-zinc-800 dark:border-b-zinc-800"
                    topBorderColor="border-t-green-600 dark:border-t-green-400"
                    hoverBorderColor="hover:border-t-green-600 hover:border-x-green-500/30 hover:border-b-green-500/30 dark:hover:border-t-green-400 dark:hover:border-x-green-500/40 dark:hover:border-b-green-500/40"
                    hoverShadowColor="hover:shadow-[0_8px_30px_rgba(22,163,74,0.12)] dark:hover:shadow-[0_8px_30px_rgba(74,222,128,0.2)]"
